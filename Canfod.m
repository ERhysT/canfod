classdef Canfod < handle

    properties 

        % Omnidriver

        omnidriver                      % Omnidriver spectrometer
        spectrometer.id                 % Spectrometer ID
        n_spectrometers                 % Number of connected spectrometers
    ...
    methods
        ...
        % Initialise omnidriver wrapper and select spectrometer
            ...
            CS.omnidriver = com.oceanoptics.omnidriver.api.wrapper.Wrapper();

            CS.n_spectrometers = int8(CS.omnidriver.openAllSpectrometers();
